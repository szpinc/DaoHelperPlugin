package me.szp.plugin.service.impl;
...
import me.szp.plugin.entity.ColumnInfo;
import me.szp.plugin.entity.SaveFile;
import me.szp.plugin.entity.TableInfo;
import me.szp.plugin.entity.TypeMapper;
import me.szp.plugin.service.TableInfoService;
import me.szp.plugin.tool.*;
...
public class TableInfoServiceImpl implements TableInfoService {
    ...
    private VirtualFile getEasyCodeConfigDirectory(Project project) {
        ...
        VirtualFile easyCodeDir = ideaDir.findChild("DaoHelperConfig");
        if (easyCodeDir == null) {
            easyCodeDir = fileUtils.createChildDirectory(project, ideaDir, "DaoHelperConfig");
        }
        return easyCodeDir;
    }

 ...
 */
@Data
@State(name = "DaoHelperSetting", storages = @Storage("dao-helper-setting.xml"))
public class Settings implements PersistentStateComponent<Settings> {
    ...
    public void initDefault() {
        ...
        this.templateGroupMap.put(DEFAULT_NAME, loadTemplateGroup(DEFAULT_NAME, DEFAULT_TEMPLATE));
        ...
        typeMapperList.add(new TypeMapper("int(\\(\\d+\\))? unsigned", "java.lang.Integer"));
        ...
        typeMapperList.add(new TypeMapper("date", "java.util.Date"));

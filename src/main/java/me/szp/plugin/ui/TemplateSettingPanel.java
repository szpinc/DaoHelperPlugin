...
import me.szp.plugin.constants.MsgValue;
import me.szp.plugin.entity.TableInfo;
import me.szp.plugin.entity.Template;
import me.szp.plugin.entity.TemplateGroup;
import me.szp.plugin.service.CodeGenerateService;
import me.szp.plugin.service.TableInfoService;
import me.szp.plugin.tool.CloneUtils;
import me.szp.plugin.tool.CollectionUtil;
import me.szp.plugin.tool.ProjectUtils;
import me.szp.plugin.ui.base.BaseGroupPanel;
import me.szp.plugin.ui.base.BaseItemSelectPanel;
    ...
    private void addDebugPanel() {
        ...
        DefaultActionGroup actionGroup = new DefaultActionGroup(new AnAction(AllIcons.Debugger.Console) {
            ...
            public void actionPerformed(AnActionEvent e) {
                ...
                FileType velocityFileType = FileTypeManager.getInstance().getFileTypeByExtension("vm");
                PsiFile psiFile = psiFileFactory.createFileFromText("DaoHelperTemplateDebug.vm.ft", velocityFileType, code, 0, true);
